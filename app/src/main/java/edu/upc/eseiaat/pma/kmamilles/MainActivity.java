...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_a_millas = (Button) findViewById(R.id.button_a_millas);
        Button btn_a_km = (Button) findViewById(R.id.button_a_km);
        ...
        btn_a_millas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("Marta", "Button_a_millas clicado");
        ...
        btn_a_km.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("Marta", "Button_a_km clicado");
